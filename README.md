...
🎓 **Final year** B.Tech Information Technology student at Sri Krishna College of Technology, Coimbatore, graduating **April 2027**
💻 Strong foundations in **Java** and **Data Structures & Algorithms**
🌐 Build full-stack web apps with **React** and **Node.js**
...
Full-stack web app automating invoice processing using UiPath RPA. Extracts invoice details (number, vendor, date, amount) from PDFs with **~90%+ accuracy**, stores structured data in Firebase Firestore, displays it on a real-time dashboard, and sends automated email notifications — cutting manual processing time by **~50%**.

`React` `Node.js` `UiPath` `Firebase`

### 💬 Real-Time Chat Application
Scalable real-time chat app with authentication and full CRUD for messages (send, edit, delete). Backend built with MongoDB, handling **100+ real-time messages** efficiently with low-latency updates via Socket.io.

`React` `Node.js` `Socket.io` `MongoDB` `Firebase`

### 🏋️ Gym Management Web App
Gym management web application with subscription plans and trainer selection, built with HTML, CSS, and JavaScript.

### 📊 CGPA Calculator
A React.js application to compute GPA and CGPA with dynamic semester and subject management.

---

## 🏆 Achievements

- 🥇 **FedEx SMART Hackathon** — Participant at IIT Madras, developed and presented a logistics solution with a team
- 🧩 **100+ DSA problems** solved on LeetCode
- 🔥 **550+ day** Duolingo streak
